...
const HTTP_PORT: u16 = kodegen_config::PORT_GITHUB - 10000;
const BINARY_NAME: &str = "kodegen-github";
const PACKAGE_NAME: &str = "kodegen_tools_github";

/// HTTP server URL for browser examples
const HTTP_URL: &str = const_format::formatcp!("http://127.0.0.1:{}/mcp", kodegen_config::PORT_GITHUB - 10000);
